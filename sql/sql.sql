...
CREATE TABLE total
(
    totalid NUMBER(5) GENERATED BY DEFAULT AS IDENTITY,
    totalname VARCHAR2(10),
    totallocation VARCHAR2(30),
    totalmenu VARCHAR2(10),
    totalprice VARCHAR2(10),
    totalscore VARCHAR2(20),
    totaltag VARCHAR2(30),
    totalfilename VARCHAR2(250),
    totalfilepath VARCHAR2(250),
    totalviewcount int not null default 0,
    totalbookmark int not null default 0,
    totaldate DATE,
    PRIMARY KEY (totalid)
