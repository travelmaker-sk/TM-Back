...
//    }
    ...
    */
    ...
    // 태그, 품목을 통한 검색
    @Transactional
    public Page<Total> TagAndCategorySearch(String searchtag, String searchcategory, Pageable pageable){
        return repository.findByTagListAndCategoryContains(searchtag,searchcategory,pageable);
    }

    // 지역, 품목을 통한 검색
    @Transactional
    public Page<Total> LocationAndCategorySearch(String searchlocation, String searchcategory, Pageable pageable){
        return repository.findByLocationAndCategoryContains(searchlocation,searchcategory,pageable);
    }

    // 지역, 태그, 품목을 통한 검색
    @Transactional
    public Page<Total> LocationAndTagAndCatgorySearch(String searchlocation,String searchtag,String searchcategory, Pageable pageable){
        return repository.findByLocationAndTagListAndCategoryContains(searchlocation,searchtag,searchcategory,pageable);
    }
