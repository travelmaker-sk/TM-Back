...
//
//    // 전체 게시물 출력
//    @GetMapping("/findall")                // 게시글 전체 출력  (3개의 게시물씩 출력)
//    public ResponseEntity<Page<Store>> findStoreAll(@PageableDefault(page = 0, size = 3, sort="storeid", direction = Sort.Direction.DESC) Pageable pageable){
//
//        Page<Store> storelist = service.storelist(pageable);
//
